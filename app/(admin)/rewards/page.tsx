...
const REWARD_TYPES = [
  { value: 'free_shipping', label: 'Free Shipping', desc: 'Waive shipping costs', icon: '🚚' },
  { value: 'discount_percent', label: 'Percentage Discount', desc: 'e.g., 10% off', icon: '💯' },
  { value: 'discount_fixed', label: 'Fixed Discount', desc: 'e.g., $5 off', icon: '🏷️' },
  { value: 'gift', label: 'Free Gift', desc: 'Free product with order', icon: '🎁' },
  { value: 'bonus_points', label: 'Bonus Points', desc: 'Loyalty program points', icon: '⭐' },
];
                  ...
                  <div key={index} className={`tier-card ${!tier.is_active ? 'inactive' : ''}`}>
                    <div className="tier-header">
                      ...
                      <div className="tier-preview" style={{ background: tier.is_active ? settings.milestone_icon_active_background : settings.milestone_icon_background }}>
                        <span>{getIconEmoji(tier.icon)}</span>
                      </div>
